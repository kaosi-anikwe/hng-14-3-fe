  ...
  return (
    <div className="drawer lg:drawer-open min-h-screen">
      ...
      <div className="drawer-side">
        ...
        <aside className="bg-base-100 w-80 min-h-full flex flex-col border-r border-base-300">
          <div className="p-6 border-b border-base-300">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-primary rounded-lg flex items-center justify-center">
                <span className="text-xl text-primary-content">I</span>
              </div>
              <div>
          ...
          <div className="p-4 border-t border-base-300">
            <div className="dropdown dropdown-top w-full">
              <div tabIndex={0} className="btn btn-ghost w-full justify-start gap-3">
                <div className="avatar placeholder">
                  <div className="bg-neutral text-neutral-content rounded-full w-10">
                    <span className="text-xs">{user?.username.split(' ').map(n => n[0]).join('')}</span>
                  </div>
                </div>
